...
--
-- Name: properties fk_anomic_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_anomic_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
